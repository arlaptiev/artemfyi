...
<ol class="notion__block-type notion__numbered-list">
    <li class="notion__numbered-list-item"><NotionBlockRichText block={block.numbered_list_item.rich_text} /></li>
    {#if block.siblings}
        {#each block.siblings as sibling}
            <li class="notion__numbered-list-item"><NotionBlockRichText block={sibling.numbered_list_item.rich_text} /></li>
        {/each}
    {/if}
</ol>
